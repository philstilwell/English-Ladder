...
def enhance_page(soup,path,prefix):
    ...
    for tag in soup.select('script[src],link[rel="stylesheet"][href]'):
        ...
        if not asset.startswith(('https:','http:','//')) and Path(asset).name in updated_assets:
            version={'site.js':'20260907-completion2','site.css':'20260907-completion2','learning.js':'20260907-completion2','app.js':'20260907-title-labels1','editorial.css':'20260907-level-navigation1','ai-practice.js':'20260906-ai1'}.get(Path(asset).name,'20260906-quality1')
