...
def page(title, content, current):
    ...
    return result.replace('</head>', '<link rel="stylesheet" href="work.css?v=20260905"><script defer src="work.js?v=20260905"></script><link rel="stylesheet" href="work-ai.css?v=20260906-ai1"><script defer src="work-ai.js?v=20260906-ai1"></script></head>')
...
<aside class="work-study-card"><p class="work-kicker">Words into action</p><p class="work-study-phrase">Read the situation.<br>Find your words.<br>Make yourself clear.</p><p>For {e(t['roles']).rstrip('.')}.</p><a href="#downloads">Choose your materials ↓</a><p><a href="#ai-practice">Explore AI practice prompts ↓</a></p></aside></section>
