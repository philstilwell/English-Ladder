...
`news_quality.py` adds a separate automated editorial gate; it is a safeguard, not proof of truth. Source evidence, release dates, available source publication dates, and retrieval dates are retained separately. Older permanent archive pages clearly identify editions that have not received the new editorial review. The latest seven releases were revised against their stored evidence on September 6, then expanded against their linked full articles on September 7 to meet the 6/8/10 minimums. The expansion records editor-written factual notes and retains the earlier review history. All 64 daily editions also received expanded vocabulary lists on September 7, with 618 additional items. The latest seven editions also received 84 additional quiz questions on September 7, bringing all 192 daily lessons to the 6/8/10 quiz minimums. Existing evergreen practice stories keep their separate six-sentence, three-item vocabulary and five-question format. The existing climate-and-aviation illustration was visually reviewed and reused for the corrected version of the same story, with that decision recorded in its metadata.
