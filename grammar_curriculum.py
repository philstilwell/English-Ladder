...
<div class="image-lightbox" hidden><button aria-label="Close enlarged image" class="image-lightbox-backdrop" data-lightbox-close type="button"></button><div class="image-lightbox-dialog" role="dialog" aria-modal="true" aria-label="{e(c['title'])}: enlarged concept graphic"><button class="image-lightbox-close" data-lightbox-close type="button">Close</button><img class="image-lightbox-image" alt=""></div></div>'''
