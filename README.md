...
- `.github/workflows/cron.yml`
  Runs the daily automation at `10:17 UTC`, with recovery attempts at `13:43 UTC` and `16:29 UTC`. Later runs resume saved progress or preserve an already published edition. It supports manual runs with `workflow_dispatch`, installs pinned dependencies, and runs the test suite before publishing lesson updates.
